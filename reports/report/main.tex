...
% [Follow up with marcus on some talking points here.]



\newpage
%\subsubsection{Data compression and Reconstruction}
% denoising signals.
% withing the data to
% efficiency of the latent space information efficiency of the latent space
...
%     \begin{subfigure}
%         \centering
%         \includegraphics[scale=0.5]{media/02-iris-loss.png}
...
%     \begin{subfigure}
%         \centering
%         \includegraphics[scale=0.5]{media/02-cancer-loss.png}
%         \label{fig:benchcancers}
%     \end{subfigure}
%     \begin{subfigure}
%         \centering
%         \includegraphics[scale=0.5]{media/02-wine-loss.png}
